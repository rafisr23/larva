        ...
        <div class="bg-white dark:bg-[#0e1726] h-full">
            <div class="flex justify-between items-center px-4 py-3">
                <a href="/" class="main-logo flex items-center shrink-0">
                    <img class="w-8 ml-[5px] flex-none" src="/images/logo.svg"
                        alt="image" />
                    <span
            ...
            <ul class="perfect-scrollbar relative font-semibold space-y-0.5 h-[calc(100vh-80px)] overflow-y-auto overflow-x-hidden  p-4 py-0"
                ...
                <li class="menu nav-item">
                    <a href="{{ route('admin.dashboard') }}" class="group @if (request()->routeIs('admin.dashboard')) active @endif">
                        <div class="flex items-center">
                            <svg class="group-hover:!text-primary shrink-0 @if (request()->routeIs('admin.dashboard')) !text-primary @endif" width="20" height="20" viewBox="0 0 24 24"
                ...
                <li class="nav-item">
                    <ul>
                        <li class="nav-item">
                            <a href="{{ route('admin.service.index') }}" class="group @if (request()->routeIs('admin.service.index')) active @endif">
                                <div class="flex items-center">
                                    <svg class="group-hover:!text-primary shrink-0 @if (request()->routeIs('admin.service.index')) !text-primary @endif" width="20" height="20"
