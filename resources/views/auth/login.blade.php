<x-layout.auth>
    ...
    <div x-data="auth">
        ...
        <div class="relative flex min-h-screen max-h-screen items-center justify-center bg-[url(/images/backgrounds/login-bg.png)] bg-cover bg-center bg-no-repeat px-6 py-10  sm:px-16">
            {{-- <img src="/images/auth/coming-soon-object1.png" alt="image" class="absolute left-0 top-1/2 h-full max-h-[893px] -translate-y-1/2" />
            <img src="/images/auth/coming-soon-object2.png" alt="image" class="absolute left-24 top-0 h-40 md:left-[30%]" />
            ...
            <div
                ...
                <div class="relative flex flex-col justify-center rounded-md bg-white/60 backdrop-blur-lg dark:bg-black/50 px-6 lg:min-h-[558px] py-10">
                    {{-- <div class="absolute top-6 end-6">
                        <div class="dropdown" x-data="dropdown" @click.outside="open = false">
                            <a href="javascript:;" class="flex items-center gap-2.5 rounded-lg border border-white-dark/30 bg-white px-2 py-1.5 text-white-dark hover:border-primary hover:text-primary dark:bg-black"
                                ...
                                <div>
                                    <img :src="`/images/flags/${$store.app.locale.toUpperCase()}.svg`" alt="image" class="h-5 w-5 rounded-full object-cover" />
                                </div>
                                ...
                                <template x-for="item in languages">
                                    <li>
                                        <a href="javascript:;" class="hover:text-primary" @click="$store.app.toggleLocale(item.value),toggle()" :class="{ 'bg-primary/10 text-primary': $store.app.locale == item.value }">
                                            <img class="h-5 w-5 rounded-full object-cover" :src="`/images/flags/${item.value.toUpperCase()}.svg`" alt="image" />
                    ...
                    <div class="mx-auto w-full max-w-[440px]">
                        <div class="mb-10">
                            <h1 class="text-3xl font-extrabold uppercase !leading-snug text-red md:text-4xl">Sign in</h1>
                            <p class="text-base font-bold leading-normal text-dark dark:text-white">Enter your email and password to login</p>
                        </div>
                        <form class="space-y-5 dark:text-white" action="{{ route('login') }}" method="POST">
                            ...
                            <div>
                                ...
                                <div class="relative text-white-dark">
                                    <input id="email" name="email" type="email" placeholder="Enter Email" required autofocus autocomplete="username" class="form-input ps-10 placeholder:text-white-dark" />
