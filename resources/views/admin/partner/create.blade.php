<x-layout.default>
    ...
    <div>
        <div class="grid gap-6 mb-6">
            ...
            <div class="panel">
                <div class="md:flex">
                    <form action="{{ route('admin.partner.store') }}" method="POST" class="flex-grow" enctype="multipart/form-data">
                        @csrf
                        <div class="grid grid-cols-1 gap-4">
                            <div class="@error('company_name') has-error @enderror">
                                <label for="company_name">Company Name <sup class="text-danger">*</sup></label>
                                <input id="company_name" name="company_name" type="text" placeholder="Enter Company Name" class="form-input" value="{{ old('company_name') }}" required/>
                                @error('company_name')
                        ...
                        <div class="mt-4 @error('description') has-error @enderror">
                            ...
                            <trix-editor input="description" class="form-input trix-editor" placeholder="Enter Description" required>{!! old('description') !!}</trix-editor>
                        ...
                        <div class="mt-4 @error('partner_logo') has-error @enderror">
                            ...
                            <input id="partner_logo" name="partner_logo" type="file" class="form-input file:py-2 file:px-4 file:border-0 file:font-semibold p-0 file:bg-primary/90 ltr:file:mr-5 rtl:file:ml-5 file:text-white file:hover:bg-primary" onchange="displayImage(this)" required />
