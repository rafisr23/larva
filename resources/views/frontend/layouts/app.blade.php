...
<body>
    ...
    <div class="shortcut-chat p-3 m-auto">
        <a href="https://wa.me/{{ $contact->phone }}" target="_blank" type="button" class="btn fs-3 rounded-circle d-flex align-items-center justify-content-center" style="width: 60px; height:60px; background-color: #25D366;" onclick="gtag_report_conversion(this.href)">
